...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-photo-world' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-photo-world' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-photo-world' ),
		'repeat'    => __( 'Repeat All', 'skt-photo-world' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'skt-photo-world' ),
		'top center'    => __( 'Top Center', 'skt-photo-world' ),
		'top right'     => __( 'Top Right', 'skt-photo-world' ),
		'center left'   => __( 'Middle Left', 'skt-photo-world' ),
		'center center' => __( 'Middle Center', 'skt-photo-world' ),
		'center right'  => __( 'Middle Right', 'skt-photo-world' ),
		'bottom left'   => __( 'Bottom Left', 'skt-photo-world' ),
		'bottom center' => __( 'Bottom Center', 'skt-photo-world' ),
		'bottom right'  => __( 'Bottom Right', 'skt-photo-world')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-photo-world' ),
		'italic'      => __( 'Italic', 'skt-photo-world' ),
		'bold'        => __( 'Bold', 'skt-photo-world' ),
		'bold italic' => __( 'Bold Italic', 'skt-photo-world' )
		);
