...
function skt_photo_world_scripts() {
	wp_enqueue_style( 'skt-photo-world-gfonts', '//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic' );
	wp_enqueue_style( 'skt-photo-world-fonts', '//fonts.googleapis.com/css?family=Roboto:400,300,700');
	wp_enqueue_style( 'skt-photo-world-basic-style', get_stylesheet_uri() );
	if ( (function_exists( 'of_get_option' )) && (of_get_option('sidebar-layout', true) != 1) ) {
		if (of_get_option('sidebar-layout', true) ==  'right') {
			wp_enqueue_style( 'skt-photo-world-layout', get_template_directory_uri()."/css/layouts/content-sidebar.css" );
		}
		else {
			wp_enqueue_style( 'skt-photo-world-layout', get_template_directory_uri()."/css/layouts/sidebar-content.css" );
		}	
	}
	else {
		wp_enqueue_style( 'skt-photo-world-layout', get_template_directory_uri()."/css/layouts/content-sidebar.css" );
	...
	wp_enqueue_style( 'skt-photo-world-editor-style', get_template_directory_uri()."/editor-style.css", array('skt_photo_world-layout') );

	wp_enqueue_style( 'skt-photo-world-main-style', get_template_directory_uri()."/css/main.css", array('skt-photo-world-layout') );
	
	wp_enqueue_style( 'skt-photo-world-supersized-default-theme', get_template_directory_uri()."/css/supersized.css" );
	
	wp_enqueue_style( 'skt-photo-world-supersized-style', get_template_directory_uri()."/css/shutter.css" );
	
	wp_enqueue_script( 'skt-photo-world-supersized-slider', get_template_directory_uri() . '/js/shutter.min.js', array('jquery') );

	wp_enqueue_script( 'skt-photo-world-supersized-shutter', get_template_directory_uri() . '/js/shutter.js', array('jquery') );
		
	wp_enqueue_script( 'skt-photo-world-shutter-min', get_template_directory_uri() . '/theme/shutter.min.js', array('jquery') );
	
	wp_enqueue_script( 'skt-photo-world-shutter', get_template_directory_uri() . '/theme/shutter.js', array('jquery') );
	
	wp_enqueue_script( 'skt-photo-world-custom', get_template_directory_uri() . '/js/custom.js', array('jquery') );
